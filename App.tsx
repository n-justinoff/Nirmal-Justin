  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute top-[40%] right-[10%] w-[30%] h-[30%] bg-indigo-600/5 rounded-full blur-[120px]"></div>
      </div>
      ...
      <main>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-indigo-900 p-12 md:p-24 text-center">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <button className="px-10 py-5 bg-white text-blue-900 rounded-2xl font-bold text-lg hover:bg-orange-500 hover:text-white transition-all duration-300 shadow-xl shadow-blue-900/20">
                    Book a Live Demo
                  </button>
                  <button className="px-10 py-5 bg-blue-800/40 backdrop-blur-md border border-blue-400/30 text-white rounded-2xl font-bold text-lg hover:bg-blue-800/60 transition-all">
